...
export const CardTemplete = ({ name, courses, icon, country, className, ratings, reviews }) => {
    return (
        <div className={`card m-auto w-60 h-fit bg-base-100 border border-gray-700 shadow-xl sm:hover:shadow-2xl sm:hover:scale-105 transition ease-in-out duration-300 ${className}`}>
            ...
            <div className="card-body p-4 gap-2">
                ...
                <label className="btn gap-2 justify-center  bg-base-300 sm:hover:fill-gray-400 active:fill-gray-400 focus:hover:fill-gray-400 fill-none transition ease-in-out duration-300" htmlFor='my-modal-66'>
                    View
                    <svg className="h-6 w-6 fill-gray-400 active:fill-gray-600" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 92 92" enableBackground="new 0 0 92 92" xmlSpace="preserve">
	...
	C50.2,38.9,51.2,39.3,51.9,40z" />
                ...
                <label className="btn justify-center  gap-2 bg-base-300 sm:hover:fill-gray-400 active:fill-gray-400 focus:hover:fill-gray-400 fill-none transition ease-in-out duration-300" htmlFor='my-modal-66'>
                    Review
