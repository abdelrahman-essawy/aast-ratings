...
const BottomAddButton = memo(({ handleAddNewItem }) => {
  return (
    <div onClick={() => handleAddNewItem()}
      className='flex sticky justify-center items-center hover:bg-base-100 p-3 active:bg-base-300 transition duration-300 cursor-pointer bg-base-300 shadow border-t border-gray-700'>
